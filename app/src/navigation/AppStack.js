...
const ResumeStackScreen = () => {
  return (
    <ResumeStack.Navigator screenOptions={{ headerShown: false }}>
      <ResumeStack.Screen name="Resume1" component={Resume1} screenOptions={{ headerShown: false }} />
      <ResumeStack.Screen name="Resume2" component={Resume2} screenOptions={{ headerShown: false }} />
      <ResumeStack.Screen name="Resume3" component={Resume3} screenOptions={{ headerShown: false }} />
      <ResumeStack.Screen name="Resume4" component={Resume4} screenOptions={{ headerShown: false }} />
      <ResumeStack.Screen name="Resume5" component={Resume5} screenOptions={{ headerShown: false }} />
      <ResumeStack.Screen name="Resume6" component={Resume6} screenOptions={{ headerShown: false }} />
