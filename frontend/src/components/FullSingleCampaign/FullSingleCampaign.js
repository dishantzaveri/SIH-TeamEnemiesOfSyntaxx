                            ...
                            <div className="container row p-3 inline-block">
                                ...
                                <div className="col-md-6 ">
                                    <div className="fullSingleCard shadow animated fadeInLeft ">
                                        <div className="card " >
                                            <img src="https://th.bing.com/th/id/OIP.otIPf0nD6Sxy3HcAhQJnGAHaE8?w=259&h=180&c=7&r=0&o=5&dpr=3&pid=1.7" className="card-img-top fullSingle-img" alt="..." />
                                            <div className="card-body">
                                                <span className="card-text pl-4"> <h3 className="font-weight" >"Title" </h3>  </span>
                                                <br />
                                ...
                                <div className="col-md-4">
                                    <div className="card details-full-sc animated fadeInRight">
                                        <div className="card-body">
                                            <h5 className="card-title"> <span className="naira-n"> ₦ </span> <b> 213 </b> <span className="grey"> raised of </span> <span className="goal--">900</span></h5>
                                        </div>
