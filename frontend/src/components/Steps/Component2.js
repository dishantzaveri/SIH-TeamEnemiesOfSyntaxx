	...
	return (
		...
		>
			...
			<Box className="education">
				<h2 style={{ fontSize: 20, margin: 10, paddingRight: "20px" }}>
					<b>Education : </b>
				</h2>
				<div>
					{data?.map((currentData, ind) => {
						return (
							<div key={currentData} id={`expense-${ind}`}>
								...
								<button
									...
									class="w-[40%] bg-purple-gray-500 hover:bg-purple-gray-600 text-white font-bold py-2 px-4 rounded m-5 "
								>
									Add Education
								</button>
								<button
