...
const Header = () => {
  return (
    <div className='px-24 py-4 flex justify-between border-b'>
      <Link className='font-bold text-3xl' to="/">mentoree</Link>
      <div className="flex gap-4 items-center">
        <Link className='font-semibold text-xl' to='/registermentor'>Become a Mentor</Link>
        <Link className='font-semibold text-xl' to='/registermentor'>Find a Mentor</Link>
  ...
  return (
    <div className='h-screen w-full flex justify-center items-center'>
      <div className="flex flex-col items-center w-[50vw]">
        <h1 className='text-6xl font-semibold text-gray-800'>Everyone needs a <span className='text-purple-gray-700'>Mentor</span></h1>
        <h1 className='text-center text-xl text-gray-700 mt-6'>Search amazing individuals around the globe, find a mentor, expand your network, and learn from incredible people!</h1>
        <div className="flex items-center border rounded-full w-full bg-white text-gray-700 mt-12 box-content">
          ...
          <input className='focus:outline-0 bg-inherit w-full' type="text" placeholder='Search Mentor' />
        ...
        <h1 className='text-xs text-greha-1 mt-4'>Tip: Search by skills, interest, location, name etc</h1>
        <h1 className='flex items-center text-xl mt-20 text-greha-3 hover:text-purple-gray-700 transition-all duration-300 cursor-pointer'>Browse all Mentors <BiRightArrowAlt className='text-2xl' /></h1>
      </div>
    </div>
  )
}
